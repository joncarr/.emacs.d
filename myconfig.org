...
#+BEGIN_SRC emacs-lisp
  ...
  (add-to-list 'exec-path (expand-file-name "~/.emacs.d/language-servers/build/install/kotlin-language-server/bin"))
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package go-mode
    :ensure t
    :mode ("\\.go\\'" . go-mode)
    :init (unbind-key "C-c C-j" go-mode-map)
    :hook ((before-save . gofmt-before-save) (go-mode . flycheck-mode))
    :config
    (setq go-tab-width 4
  ...
  (use-package lsp-go
    ...
    :hook ((go-mode . lsp) (go-mode . (lambda ()
