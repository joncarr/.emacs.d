...
#+BEGIN_SRC emacs-lisp
  (evil-leader/set-key
    "ja" 'go-goto-arguments
    "ji" 'go-goto-imports
    "jf" 'go-goto-function
    "jn" 'go-goto-function-name
    "jr" 'go-goto-return-values
    "jm" 'go-goto-method-receiver
    "jc" 'go-goto-docstring
    "jd" 'go-guru-definition
    "ia" 'go-import-add
    ...
    "gs" 'go-guru-set-scope
    "gc" 'go-guru-callstack
